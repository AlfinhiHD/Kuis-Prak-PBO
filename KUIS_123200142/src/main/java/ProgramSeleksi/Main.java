        ...
        if (pilih == 1){
           ...
           do {
               ...
               switch (Menu) {
                   case 1 -> {
                       System.out.println("Input Nilai Tes Tulis : ");
                       androidDev.inputTulis(input.nextInt());
                       System.out.println("Input Nilai Tes Coding : ");
                       androidDev.inputCoding(input.nextInt());
                       System.out.println("Input Nilai Tes Wawancara : ");
                       androidDev.inputWawancara(input.nextInt());
                    }
                   case 2 -> {
                       System.out.println("Nilai Akhir : " + androidDev.nilaiAkhir());
           ...
           do {
               ...
               switch (Menu) {
                   case 1 -> {
                       System.out.println("Input Nilai Tes Tulis : ");
                       webDev.inputTulis(input.nextInt());
                       System.out.println("Input Nilai Tes Coding : ");
                       webDev.inputCoding(input.nextInt());
                       System.out.println("Input Nilai Tes Wawancara : ");
                       webDev.inputWawancara(input.nextInt());
                    }
                   case 2 -> {
                       System.out.println("Nilai Akhir : " + webDev.nilaiAkhir());
